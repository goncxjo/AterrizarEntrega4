...
public class OceanicDummy implements AerolineaOceanic {
    ...
    public OceanicDummy() {
        ...
        asientos.add(new AsientoDTO("OCE 271", 42, new Date(), null, 1000.00, new Turista(), Ubicacion.Ventanilla));
        asientos.add(new AsientoDTO("OCE 271", 46, new Date(), null, 1400.00, new Turista(), Ubicacion.Centro));
        asientos.add(new AsientoDTO("OCE 271", 12, new Date(), null, 2000.00, new PrimeraClase(), Ubicacion.Centro));
        asientos.add(new AsientoDTO("OCE 271", 37, new Date(), null, 1700.00, new Ejecutivo(), Ubicacion.Centro));
        asientos.add(new AsientoDTO("OCE 079", 35, new Date(), null, 1800.00, new PrimeraClase(), Ubicacion.Pasillo));
        asientos.add(new AsientoDTO("OCE 079", 42, new Date(), null, 1000.00, new Turista(), Ubicacion.Ventanilla));
        asientos.add(new AsientoDTO("OCE 079", 46, new Date(), null, 1400.00, new Turista(), Ubicacion.Centro));
        asientos.add(new AsientoDTO("OCE 505", 12, new Date(), null, 2000.00, new PrimeraClase(), Ubicacion.Centro));
        asientos.add(new AsientoDTO("OCE 505", 35, new Date(), null, 1800.00, new PrimeraClase(), Ubicacion.Pasillo));
        asientos.add(new AsientoDTO("OCE 505", 37, new Date(), null, 1700.00, new Ejecutivo(), Ubicacion.Centro));
        asientos.add(new AsientoDTO("OCE 179", 46, new Date(), null, 1400.00, new Turista(), Ubicacion.Centro));
        asientos.add(new AsientoDTO("OCE 179", 12, new Date(), null, 2000.00, new PrimeraClase(), Ubicacion.Centro));

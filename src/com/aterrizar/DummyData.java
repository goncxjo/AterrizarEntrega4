...
public class DummyData {
    ...
    public DummyData() {
        ...
        when(mockLanchita.asientosDisponibles(anyString(), anyString(), anyString(), anyString()))
                .thenReturn(
                        Arrays.asList(
                                Arrays.asList("LCH 344-42","1000.00","T","V","D", "12.0", "6.0")
                                , Arrays.asList("LCH 344-46","1400.00","T","C","D", "12.0", "4.0")
                                , Arrays.asList("LCH 344-12","2000.00","P","C","D", "10.0", "4.0")
                                , Arrays.asList("LCH 344-35","1800.00","P","P","D", "13.0", "1.0")
                                , Arrays.asList("LCH 344-37","1700.00","E","C","D", "11.0", "2.0")
                        )
                );
    }
